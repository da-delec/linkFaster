      ...
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-18">
            <Image height={100} width={80} alt="Logo" src={srcLogo} />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref} className=" size-16">
            <FaGithub className="text-gray-800 size-6" />
          </Circle>
          <Circle ref={div2Ref} className=" size-16">
            <SiUpwork className="text-green-600 size-6" />
          </Circle>
          <Circle ref={div3Ref} className=" size-16">
            <SiFiverr className="text-green-500 size-6" />
          </Circle>
          <Circle ref={div4Ref} className=" size-16">
            <SiFreelancer className="text-blue-600 size-6" />
          </Circle>
          <Circle ref={div5Ref} className=" size-16">
            <FaLinkedin className="text-blue-700 size-6" />
          </Circle> 
        </div>
      </div>
