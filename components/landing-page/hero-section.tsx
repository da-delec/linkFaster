...
export default function HeroGeometric({
  badge = 'LinkFaster',
  title1 = 'Your entire professional profile',
  title2 = 'in One Link',
}: {
  badge?: string;
  title1?: string;
      ...
      <div className="relative z-10 container mx-auto max-w-6xl px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            Centralize your portfolio, social links, projects, and resume in one professional link. Share it anywhere, get noticed everywhere.
            </p>
          </motion.div>
